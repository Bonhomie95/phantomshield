...
export type ActivityEventType = 'app_opened' | 'app_closed' | 'screen_unlocked' | 'screen_locked' | 'phantom_opened' | 'anomaly_detected';
...
export type WSMessageType = 'connected' | 'activity_event' | 'intruder_alert' | 'anomaly_alert' | 'device_locked' | 'device_wipe_logs' | 'ping' | 'pong';
